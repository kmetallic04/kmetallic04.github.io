const navigation = document.querySelector(".header_nav > nav");
const headerContainer = document.querySelector(".header_nav > .container")
const mobileNav = document.querySelector(".header_nav > .menu_button");
...
function onScroll() {
  if (window.innerWidth > 1000) {
    if (window.pageYOffset > navBottom && window.innerWidth > 1000) {
      ...
      headerContainer.setAttribute("style", "padding: auto;");
    }
  }
}
